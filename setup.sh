...
YELLOW="\e[0;33m"
GREEN="\e[0;32m"
NC="\e[0m"  # No color / color reset


init_submodules () {
    echo "Initializing submodules..."

    NUMBER_OF_SUBMODULES=$(git submodule | wc -l)

    # TODO: If number is less than 1, ask for url to the users dotfiles repo
    #       If number is greater than 1, throw an error.
